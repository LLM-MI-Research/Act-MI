...
> **A practical survey on how to locate interpretable objects, steer model behaviors, and improve LLM capabilities (Alignment, Capability, Efficiency) via Mechanistic Interpretability.**
...
| :--- | :--- | :--- | :--- | :---: | :---: | :---: |
| **On the Role of Attention Heads in Large Language Model Safety** | Attention | Causal Attribution | Amplitude Manipulation | ICLR | 2025 | [Link](https://openreview.net/forum?id=h0Ak8A5yqw) |
| **Pierce the Mists, Greet the Sky: Decipher Knowledge Overshadowing via Knowledge Circuit Analysis** | Attention | Circuit Discovery | Targeted Optimization | EMNLP | 2025 | [Link](https://aclanthology.org/2025.emnlp-main.781/) |
...
| **Improving Instruction-Following in Language Models through Activation Steering** | Residual Stream | Gradient Detection | Vector Arithmetic | ICLR | 2025 | [Link](https://openreview.net/forum?id=wozhdnRCtw) |
| **Refine Large Language Model Fine-tuning via Instruction Vector** | Attention | Causal Attribution | Targeted Optimization | ArXiv | 2024 | [Link](https://arxiv.org/abs/2406.12227) |
...
| Paper | Object | Localizing Method | Steering Method | Venue | Year | Link |
| :--- | :--- | :--- | :--- | :---: | :---: | :---: |
| **Investigating Gender Bias in Language Models Using Causal Mediation Analysis** | Attention | Causal Attribution | Amplitude Manipulation | NeurIPS | 2020 | [Link](https://proceedings.neurips.cc/paper/2020/file/92650b2e92217715fe312e6fa7b90d82-Paper.pdf) |
| **Identifying and Adapting Transformer-Components Responsible for Gender Bias in an English Language Model** | Attention | Causal Attribution | Targeted Optimization | ACLWS | 2023 | [Link](https://aclanthology.org/2023.blackboxnlp-1.29/) |
...
| **Dissecting Bias in LLMs: A Mechanistic Interpretability Perspective** | Attention | Magnitude Analysis | Amplitude Manipulation | TMLR | 2025 | [Link](https://openreview.net/forum?id=EpQ2CBJTjD) |
...
| **Eliminating Position Bias of Language Models: A Mechanistic Approach** | Attention | Magnitude Analysis | Amplitude Manipulation | ICLR | 2025 | [Link](https://openreview.net/forum?id=fvkElsJOsN) |
...
| **Tracing Positional Bias in Financial Decision-Making: Mechanistic Insights from Qwen2.5** | Attention | Magnitude Analysis | - | ICAIF | 2025 | [Link](https://arxiv.org/abs/2508.18427) |
...
| **Linear Representations of Political Perspective Emerge in Large Language Models** | Attention | Probing | Vector Arithmetic | ICLR | 2025 | [Link](https://openreview.net/forum?id=rwqShzb9li) |
...
| **Interpreting Arithmetic Mechanism in Large Language Models through Comparative Neuron Analysis** | Attention | Causal Attribution | Amplitude Manipulation | EMNLP | 2024 | [Link](https://aclanthology.org/2024.emnlp-main.193/) |
| **Back Attention: Understanding and Enhancing Multi-Hop Reasoning in Large Language Models** | Attention | Causal Attribution | - | EMNLP | 2025 | [Link](https://aclanthology.org/2025.emnlp-main.567/) |
...
| **Chain-of-Thought in Large Language Models: Decoding, Projection, and Activation** | FFN & Attention | Magnitude Analysis | - | ArXiv | 2024 | [Link](https://arxiv.org/abs/2412.03944) |
...
| **Cutting Off the Head Ends the Conflict: A Mechanism for Interpreting and Mitigating Knowledge Conflicts in Language Models** | Attention | Causal Attribution | Amplitude Manipulation | ACL | 2024 | [Link](https://doi.org/10.18653/v1/2024.findings-acl.70) |
| **Interpreting Key Mechanisms of Factual Recall in Transformer-Based Language Models** | Attention | Causal Attribution | Amplitude Manipulation | ArXiv | 2024 | [Link](https://arxiv.org/abs/2403.19521) |
| **Llama See, Llama Do: A Mechanistic Perspective on Contextual Entrainment and Distraction in LLMs** | Attention | Causal Attribution | Amplitude Manipulation | ACL | 2025 | [Link](https://aclanthology.org/2025.acl-long.791/) |
| **Probing and Boosting Large Language Models Capabilities via Attention Heads** | Attention | Probing | Targeted Optimization | EMNLP | 2025 | [Link](https://aclanthology.org/2025.emnlp-main.1450/) |
| **TIES-Merging: Resolving Interference When Merging Models** | FFN & Attention | Magnitude Analysis | Vector Arithmetic | NeurIPS | 2023 | [Link](https://proceedings.neurips.cc/paper_files/paper/2023/hash/1644c9af28ab7916874f6fd6228a9bcf-Abstract-Conference.html) |
| **Neuron-Level Knowledge Attribution in Large Language Models** | FFN & Attention | Magnitude Analysis | Amplitude Manipulation | EMNLP | 2024 | [Link](https://aclanthology.org/2024.emnlp-main.191.pdf) |
| **Balancing Speciality and Versatility: a Coarse to Fine Framework for Supervised Fine-tuning Large Language Model** | FFN & Attention | Magnitude Analysis | Targeted Optimization | ACL | 2024 | [Link](https://doi.org/10.18653/v1/2024.findings-acl.445) |
| **Knowledge Localization: Mission Not Accomplished? Enter Query Localization!** | FFN & Attention | Magnitude Analysis | Amplitude Manipulation | ICLR | 2025 | [Link](https://openreview.net/forum?id=tfyHbvFZ0K) |
| **Enhancing Large Language Model Performance with Gradient-Based Parameter Selection** | FFN & Attention | Magnitude Analysis | Targeted Optimization | AAAI | 2025 | [Link](https://doi.org/10.1609/aaai.v39i23.34621) |
| **The Geometry of Forgetting: Analyzing Machine Unlearning through Local Learning Coefficients** | FFN & Attention | Magnitude Analysis | - | ICML | 2025 | [Link](https://openreview.net/forum?id=qKh7Aip3JC) |
| **Knowledge Circuits in Pretrained Transformers** | FFN & Attention | Circuit Discovery | Amplitude Manipulation | NeurIPS | 2024 | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/d6df31b1be98e04be48af8bedb95b499-Paper-Conference.pdf) |
| **Towards Secure Tuning: Mitigating Security Risks Arising from Benign Instruction Fine-Tuning** | FFN & Attention | Probing | Targeted Optimization | ArXiv | 2024 | [Link](https://doi.org/10.48550/arXiv.2410.04524) |
...
| **Sens-Merging: Sensitivity-Guided Parameter Balancing for Merging Large Language Models** | FFN & Attention | Gradient Detection | Vector Arithmetic | ACL | 2025 | [Link](https://aclanthology.org/2025.findings-acl.984/) |
| **Activation-Guided Consensus Merging for Large Language Models** | FFN & Attention | Magnitude Analysis | Vector Arithmetic | NeurIPS | 2025 | [Link](https://openreview.net/pdf?id=ayzWTxb9ZD) |
...
| **Optimizing Multimodal Language Models through Attention-based Interpretability** | Attention | Magnitude Analysis | Targeted Optimization | ICAI | 2025 | [Link](https://arxiv.org/abs/2511.23375) |
| **In-context Learning and Induction Heads** | Attention | Magnitude Analysis | - | ArXiv | 2022 | [Link](https://arxiv.org/abs/2209.11895) |
| **How Transformers Implement Induction Heads: Approximation and Optimization Analysis** | Attention | Magnitude Analysis | - | ArXiv | 2024 | [Link](https://openreview.net/forum?id=1lFZusYFHq) |
| **What needs to go right for an induction head? a mechanistic study of in-context learning circuits and their formation** | Attention | Magnitude Analysis | - | ICML | 2024 | [Link](https://dl.acm.org/doi/abs/10.5555/3692070.3693925) |
| **The developmental landscape of in-context learning** | Attention | Magnitude Analysis | - | TLMR | 2025 | [Link](https://arxiv.org/abs/2402.02364) |
| **In-Context Meta Learning Induces Multi-Phase Circuit Emergence** | Attention | Magnitude Analysis | - | ICLR | 2025 | [Link](https://openreview.net/forum?id=LNMfzv8TNb) |
| **Joint Localization and Activation Editing for Low-Resource Fine-Tuning** | Attention | Magnitude Analysis | Vector Arithmetic | ICML | 2025 | [Link](https://openreview.net/pdf?id=Lllg9YjAFX) |
| **The slingshot mechanism: An empirical study of adaptive optimizers and the Grokking Phenomenon** | Attention & FFN | Magnitude Analysis | - | NeurIPS | 2022 | [Link](https://openreview.net/pdf?id=lY1e0PNkSJ) |
| **Explaining grokking through circuit efficiency** | Attention & FFN | Magnitude Analysis | - | ArXiv | 2023 | [Link](https://arxiv.org/pdf/2309.02390) |
| **Towards Empirical Interpretation of Internal Circuits and Properties in Grokked Transformers on Modular Polynomials** | Attention & FFN | Magnitude Analysis | - | TMLR | 2024 | [Link](https://openreview.net/forum?id=MzSf70uXJO) |
| **Progress measures for grokking via mechanistic interpretability** | Attention & FFN | Magnitude Analysis | - | ICLR | 2023 | [Link](https://openreview.net/forum?id=9XFSbDPmdW) |
| **Predicting grokking long before it happens: A look into the loss landscape of models which grok** | Attention & FFN | Magnitude Analysis | - | ArXiv | 2023 | [Link](https://arxiv.org/abs/2306.13253) |
| **Exploring Grokking: Experimental and Mechanistic Investigations** | Attention & FFN | Magnitude Analysis | - | ArXiv | 2024 | [Link](https://arxiv.org/pdf/2412.10898) |
| **Omnigrok: Grokking Beyond Algorithmic Data** | Attention & FFN | Magnitude Analysis | - | ICLR | 2023 | [Link](https://openreview.net/forum?id=zDiHoIWa0q1) |
| **Grokking of implicit reasoning in transformers: A mechanistic journey to the edge of generalization** | Attention & FFN | Magnitude Analysis | - | NeurIPS | 2024 | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/ad217e0c7fecc71bdf48660ad6714b07-Paper-Conference.pdf) |
| **Unified View of Grokking, Double Descent and Emergent Abilities: A Comprehensive Study on Algorithm Task** | Attention & FFN | Magnitude Analysis | - | COLM | 2024 | [Link](https://arxiv.org/pdf/2402.15175) |
| **Fine-Tuning is Subgraph Search: A New Lens on Learning Dynamics** | Attention & FFN | Circuit Discovery | Targeted Optimization | ArXiv | 2025 | [Link](https://www.arxiv.org/pdf/2502.06106) |
| **Where to find Grokking in LLM Pretraining? Monitor Memorization-to-Generalization without Test** | Neuron | Magnitude Analysis | - | ArXiv | 2025 | [Link](https://openreview.net/forum?id=cG1EbmWiSs) |

#### Efficient Inference
| Paper | Object | Localizing Method | Steering Method | Venue | Year | Link |
| :--- | :--- | :--- | :--- | :---: | :---: | :---: |
| **TokenSkip: Controllable Chain-of-Thought Compression in LLMs** | Token Embedding | Magnitude Analysis | Amplitude Manipulation | EMNLP | 2025 | [Link](https://aclanthology.org/2025.emnlp-main.165/) |
...
| **Razorattention: Efficient kv cache compression through retrieval heads** | Attention | Circuit Discovery | Amplitude Manipulation | ICLR | 2025 | [Link](https://iclr.cc/virtual/2025/poster/28028) |
| **Duoattention: Efficient long-context llm inference with retrieval and streaming heads** | Attention | Circuit Discovery | Amplitude Manipulation | ICLR | 2025 | [Link](https://openreview.net/forum?id=cFu7ze7xUm) |
...
| **Unveiling visual perception in language models: An attention head analysis approach** | Attention | Magnitude Analysis | - | CVPR | 2025 | [Link](https://openaccess.thecvf.com/content/CVPR2025/papers/Bi_Unveiling_Visual_Perception_in_Language_Models_An_Attention_Head_Analysis_CVPR_2025_paper.pdf) |
...
| **Rotatekv: Accurate and robust 2-bit kv cache quantization for llms via outlier-aware adaptive rotations** | Attention | Magnitude Analysis | Amplitude Manipulation | IJCAI | 2025 | [Link](https://www.ijcai.org/proceedings/2025/690) |
| **KVSink: Understanding and Enhancing the Preservation of Attention Sinks in KV Cache Quantization for LLMs** | FFN & Attention | Circuit Discovery | - | COLM | 2025 | [Link](https://openreview.net/forum?id=gIqb6zWZoO) |
| **Efficient Streaming Language Models with Attention Sinks** | Attention | Magnitude Analysis | Amplitude Manipulation | ICLR | 2024 | [Link](https://openreview.net/forum?id=NG7sS51zVF) |
| **Massive activations in large language models** | FFN & Attention | Magnitude Analysis | - | NeurIPS | 2024 | [Link](https://openreview.net/forum?id=F7aAhfitX6) |
| **Systematic outliers in large language models** | FFN & Attention | Circuit Discovery | - | ICLR | 2025 | [Link](https://openreview.net/forum?id=rLX7Vyyzus) |
| **Quantizable Transformers: Removing Outliers by Helping Attention Heads Do Nothing** | FFN & Attention | Circuit Discovery | - | NeurIPS | 2023 | [Link](https://proceedings.neurips.cc/paper_files/paper/2023/hash/edbcb7583fd8921dad78adecfe06a99b-Abstract-Conference.html) |
